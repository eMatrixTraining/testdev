/*=========================================================================================
    ...
    $(window).on('load', function () {
       ...
       *************************************************/
        ...
        var kudosDonutChart = new Chartist.Pie('#Kudos-donut-chart', {
            series: [100],
            labels: ['iOS']
        }, {
            donut: true,
        ...
        kudosDonutChart.on('draw', function (data) {
            if (data.type === 'label') {
                if (data.index === 0) {
                    data.element.attr({
                        dx: data.element.root().width() / 2,
        ...
        // For the sake of the example we update the chart every time it's created with a delay of 8 seconds
        kudosDonutChart.on('created', function (data) {
            var defs = data.svg.querySelector('defs') || data.svg.elem('defs');
            defs.elem('linearGradient', {
                id: 'donutGradient1',
                x1: 0,
        ...
        var goalsDonutChart = new Chartist.Pie('#Goals-donut-chart', {
            series: [100],
            labels: ['iOS']
        }, {
            donut: true,
        ...
        goalsDonutChart.on('draw', function (data) {
            if (data.type === 'label') {
                if (data.index === 0) {
                    data.element.attr({
                        dx: data.element.root().width() / 2,
        ...
        // For the sake of the example we update the chart every time it's created with a delay of 8 seconds
        goalsDonutChart.on('created', function (data) {
            var defs = data.svg.querySelector('defs') || data.svg.elem('defs');
            defs.elem('linearGradient', {
                id: 'donutGradient1',
                x1: 0,
        ...
        var skillsDonutChart = new Chartist.Pie('#Skills-donut-chart', {
            series: [100],
            labels: ['iOS']
        }, {
            donut: true,
        ...
        skillsDonutChart.on('draw', function (data) {
            if (data.type === 'label') {
                if (data.index === 0) {
                    data.element.attr({
                        dx: data.element.root().width() / 2,
        ...
        // For the sake of the example we update the chart every time it's created with a delay of 8 seconds
        skillsDonutChart.on('created', function (data) {
            var defs = data.svg.querySelector('defs') || data.svg.elem('defs');
            defs.elem('linearGradient', {
                id: 'donutGradient1',
                x1: 0,
